...
trimdir='../data/trimm'
genomedir='../data/references/star_index_house'
reference='../data/references/house_sparrow_genome_assembly-18-11-14.fa'

mkdir -p ../data/mapping/star/star_house_reference
outdir='../data/mapping/star/star_house_reference'
...
sbatch star_align_reads.sh $genomedir ${Read_1} ${Read_2} ${outdir}/${sampledir}/${sampledir}_
